...
class PeticionTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.user = User(id=20, username='voter1')
        self.user.set_password('123')
        self.user.save()
        self.p = PeticionCenso(id=1, desc="Votacion 1", user_id=self.user.id)
        self.p.save()
        super().setUp()
